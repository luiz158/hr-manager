...
$(function () {
    ...
    $.AdminLTE.treeViewOnPageLoad("test");
...
//            var checkElement = $(".sidebar-menu").find("personal-section");
    ...
    $.AdminLTE.treeViewOnPageLoad = function (menu) {
        ...
        $( document ).ready(function() {
            ...
            $('.personal-section .treeview-menu').slideDown(animationSpeed, function () {
                //Add the class active to the parent li
                $(".personal-section").addClass('active');
                $('.personal-section .treeview-menu').addClass('menu-open');
            });
        });
    };
