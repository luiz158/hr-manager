...
<%--<head>--%>
    ...
    <%--<!-- Bootstrap 3.3.5 -->--%>
    <%--&lt;%&ndash;<link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">&ndash;%&gt;--%>
        ...
        <%--<div class="box-body">--%>
            ...
            <%--<div class="direct-chat-messages">--%>
                ...
                <%--<div class="direct-chat-msg">--%>
                    ...
                    <%--<img class="direct-chat-img" src="${imageHome}/user1-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->--%>
                ...
                <%--<div class="direct-chat-msg right">--%>
                    ...
                    <%--</div><!-- /.direct-chat-info -->--%>
                    <%--<img class="direct-chat-img" src="${imageHome}/user3-128x128.jpg" alt="message user image"><!-- /.direct-chat-img -->--%>
                    <%--<div class="direct-chat-text">--%>
            ...
            <%--<div class="direct-chat-contacts">--%>
                <%--<ul class="contacts-list">--%>
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user1-128x128.jpg">--%>
                    ...
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user7-128x128.jpg">--%>
                            <%--<div class="contacts-list-info">--%>
                                <%--<span class="contacts-list-name">--%>
                                  <%--Sarah Doe--%>
                    ...
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user3-128x128.jpg">--%>
                            <%--<div class="contacts-list-info">--%>
                                <%--<span class="contacts-list-name">--%>
                                  <%--Nadia Jolie--%>
                    ...
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user5-128x128.jpg">--%>
                            <%--<div class="contacts-list-info">--%>
                                <%--<span class="contacts-list-name">--%>
                                  <%--Nora S. Vans--%>
                    ...
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user6-128x128.jpg">--%>
                            <%--<div class="contacts-list-info">--%>
                                <%--<span class="contacts-list-name">--%>
                                  <%--John K.--%>
                    ...
                    <%--<li>--%>
                        <%--<a href="#">--%>
                            <%--<img class="contacts-list-img" src="${imageHome}/user8-128x128.jpg">--%>
                            <%--<div class="contacts-list-info">--%>
                                <%--<span class="contacts-list-name">--%>
                                  <%--Kenneth M.--%>
    ...
    <%--<div class="box box-danger">--%>
        ...
        <%--<div class="box-body no-padding">--%>
            <%--<ul class="users-list clearfix">--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user1-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Alexander Pierce</a>--%>
                    <%--<span class="users-list-date">Today</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user8-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Norman</a>--%>
                    <%--<span class="users-list-date">Yesterday</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user7-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Jane</a>--%>
                    <%--<span class="users-list-date">12 Jan</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user6-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">John</a>--%>
                    <%--<span class="users-list-date">12 Jan</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user2-160x160.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Alexander</a>--%>
                    <%--<span class="users-list-date">13 Jan</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user5-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Sarah</a>--%>
                    <%--<span class="users-list-date">14 Jan</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user4-128x128.jpg" alt="User Image">--%>
                    <%--<a class="users-list-name" href="#">Nora</a>--%>
                    <%--<span class="users-list-date">15 Jan</span>--%>
                <%--</li>--%>
                <%--<li>--%>
                    <%--<img src="${imageHome}/user3-128x128.jpg" alt="User Image">--%>
            ...
            <%--<ul class="products-list product-list-in-box">--%>
                <%--<li class="item">--%>
                    <%--<div class="product-img">--%>
                        <%--<img src="${imageHome}/default-50x50.gif" alt="Product Image">--%>
                    <%--</div>--%>
