...
<head>
    ...
    <spring:url value="/resources/css/bootstrap/bootstrap.css" var="bootstrapCss" />
    <spring:url value="/resources/css/AdminLTE.css" var="applicationMainCss" />
    <spring:url value="/resources/css/skins/_all-skins.min.css" var="allSkinsCss" />
    ...
    <spring:url value="/resources/img" var="imageHome" />
    <spring:url value="/resources/js/jQuery-2.1.4.min.js" var="jqueryJs" />
    <spring:url value="/resources/js/bootstrap.js" var="bootstrapJs" />
    <spring:url value="/resources/js/jquery.slimscroll.js" var="slimScrollJs" />
    <spring:url value="/resources/js/fastclick.js" var="fastClickJs" />
    <spring:url value="/resources/js/app.js" var="appJs" />
    <spring:url value="/resources/js/demo.js" var="demoJs" />
    ...
    <!-- Theme style -->
    <link href="${applicationMainCss}" rel="stylesheet" type="text/css" />

    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <%--<link href="../dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />--%>
    <link href="${allSkinsCss}" rel="stylesheet" type="text/css" />
